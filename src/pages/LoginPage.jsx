        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <button
              ...
              className="font-medium text-[#0E5ACD] hover:text-[#0B4DB0]"
            >
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  className="appearance-none relative block w-full pl-10 pr-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-[#0E5ACD] focus:border-[#0E5ACD] focus:z-10 sm:text-sm"
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#0E5ACD] hover:bg-[#0B4DB0] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0E5ACD] disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0E5ACD]"
              >
